...
import type { SwingRunSummary as Summary } from "../../types/swing";

interface Props {
  summary: Summary;
}

export default function SwingRunSummary({ summary }: Props) {
  const overBudget =
  ...
  return (
    <section className="run-summary">
      ...
      <div className={overBudget ? "summary-alert" : ""}>
        ...
        <strong>
          {summary.llm_calls_used} LLM · {summary.april500_calls_used} April 500 · ${summary.provider_cost_estimate_usd.toFixed(2)}
        </strong>
      </div>
    </section>
  );
